@echo off
REM Run Token Tracking Tests with Coverage
REM This script runs only the token tracking tests and generates a coverage report
...
REM Run all token-related tests
...
REM Show coverage for token tracking modules only
