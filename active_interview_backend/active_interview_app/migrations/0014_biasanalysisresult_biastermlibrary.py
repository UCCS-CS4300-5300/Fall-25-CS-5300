    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.PositiveIntegerField(help_text='ID of the specific object')),
                ('flagged_terms', models.JSONField(default=list, help_text='List of detected bias terms with details. Structure: [{"term": str, "category": str, "severity": int, "positions": [int], "suggestions": [str]}, ...]')),
